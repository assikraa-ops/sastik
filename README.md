...
<head>  
  ...
  </script>    <link rel="stylesheet" href="/sastik/assets/css/style.css?v=a9c3450857110ad44de46de247294a3e4e4d0113">    
  <style>  
    :root{  
      --merah-tua:#8B0000;  
      --merah-cerah:#e63946;  
  ...
  <script>  
    ...
    imgs.forEach(img=>{  
      img.addEventListener('click',()=>{  
        ...
        // Perbaikan: Hapus teks nama file dari pop-up galeri juga
    ...
    (function(){  
      ...
      canvas.id='bintang';  
      // Perbaikan: Pastikan canvas bintang ditempatkan di body dan memiliki CSS agar tidak mengganggu interaksi
      canvas.style.position = 'fixed';
      canvas.style.top = '0';
      canvas.style.left = '0';
      canvas.style.zIndex = '-1'; /* Pindahkan ke belakang konten */
